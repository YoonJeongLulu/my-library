...
export default function useDraggableScroll(
  ...
  const mouseUpHandler = () => {
    ...
    if (ref.current) {
      ...
      setCurrentLeft(ref.current.scrollLeft);
    }
  ...
  return { onMouseDown, currentLeft };
}

// Usage
// const ref = useRef(null);
// const { onMouseDown, currentLeft } = useDraggableScroll(ref, { direction: "horizontal" });
// <div ref={ref} onMouseDown={onMouseDown}>ㅎㅇ</div>
